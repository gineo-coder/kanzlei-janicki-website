      ...
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div className="relative">
             <div className="absolute -top-4 -left-4 w-full h-full border-4 border-brand-accent rounded-md z-0"></div>
          ...
          <div className="text-brand-dark-text">
            <h4 className="font-bold text-brand-accent uppercase tracking-widest font-body">Kanzlei Dr. Janicki</h4>
            <h2 className="text-3xl lg:text-4xl font-black text-brand-heading font-display mt-2 mb-6">Fachanwälte für Arbeitsrecht</h2>
            <p className="text-brand-gray mb-6 text-lg leading-relaxed font-body">
            ...
            <ul className="space-y-4 font-body text-brand-gray">
                <li className="flex items-start">
                    <svg className="w-6 h-6 text-brand-accent mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
